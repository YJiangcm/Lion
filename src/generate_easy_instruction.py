"""
run:
python -m generate_easy_instruction generate_instruction_following_data --num_instructions_to_generate 3000
"""
import time
import json
import os
...
def encode_prompt(prompt_instructions):
    ...
    prompt = open("prompt_easy.txt").read() + "\n"
    inst_i_o = []
...
def generate_instruction_following_data(
    ...
    if os.path.exists(os.path.join(output_dir, "no_hard_regen.json")):
        machine_instruction_data = utils.jload(os.path.join(output_dir, "no_hard_regen.json"))
    ...
    while len(machine_instruction_data) < num_instructions_to_generate:
        ...
        utils.jdump(machine_instruction_data, os.path.join(output_dir, "no_hard_regen.json"))
