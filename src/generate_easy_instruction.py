...
def generate_instruction_following_data(
    ...
    if os.path.exists(os.path.join(output_dir, "easy_regen.json")):
        machine_instruction_data = utils.jload(os.path.join(output_dir, "easy_regen.json"))
    ...
    while len(machine_instruction_data) < num_instructions_to_generate:
        ...
        utils.jdump(machine_instruction_data, os.path.join(output_dir, "easy_regen.json"))
